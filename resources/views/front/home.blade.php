                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="item pb_25">
                            <div class="photo">
                                <a href="destination.html"><img src="{{ asset('uploads/destination-1.jpg') }}" alt=""></a>
                            </div>
                            <div class="text">
                                <h2>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="item pb_25">
                            <div class="photo">
                                <a href="destination.html"><img src="{{ asset('uploads/destination-2.jpg') }}" alt=""></a>
                            </div>
                            <div class="text">
                                <h2>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="item pb_25">
                            <div class="photo">
                                <a href="destination.html"><img src="{{ asset('uploads/destination-3.jpg') }}" alt=""></a>
                            </div>
                            <div class="text">
                                <h2>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="item pb_25">
                            <div class="photo">
                                <a href="destination.html"><img src="{{ asset('uploads/destination-4.jpg') }}" alt=""></a>
                            </div>
                            <div class="text">
                                <h2>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="item pb_25">
                            <div class="photo">
                                <a href="destination.html"><img src="{{ asset('uploads/destination-5.jpg') }}" alt=""></a>
                            </div>
                            <div class="text">
                                <h2>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="item pb_25">
                            <div class="photo">
                                <a href="destination.html"><img src="{{ asset('uploads/destination-6.jpg') }}" alt=""></a>
                            </div>
                            <div class="text">
                                <h2>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="item pb_25">
                            <div class="photo">
                                <a href="destination.html"><img src="{{ asset('uploads/destination-7.jpg') }}" alt=""></a>
                            </div>
                            <div class="text">
                                <h2>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="item pb_25">
                            <div class="photo">
                                <a href="destination.html"><img src="{{ asset('uploads/destination-8.jpg') }}" alt=""></a>
                            </div>
                            <div class="text">
                                <h2>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="item pb_25">
                            <div class="photo">
                                <a href="package.html"><img src="{{ asset('uploads/package-1.jpg') }}" alt=""></a>
                                <div class="wishlist">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="item pb_25">
                            <div class="photo">
                                <a href="package.html"><img src="{{ asset('uploads/package-2.jpg') }}" alt=""></a>
                                <div class="wishlist">
                                    <a href=""><i class="far fa-heart"></i></a>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="item pb_25">
                            <div class="photo">
                                <a href="package.html"><img src="{{ asset('uploads/package-3.jpg') }}" alt=""></a>
                                <div class="wishlist">
                                    <a href=""><i class="far fa-heart"></i></a>
                                </div>
                            </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="item pb_70">
                            <div class="photo">
                                <img src="{{ asset('uploads/blog-2.jpg') }}" alt="" />
                            </div>
                            <div class="text">
                                <h2>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="item pb_70">
                            <div class="photo">
                                <img src="{{ asset('uploads/blog-3.jpg') }}" alt="" />
                            </div>
                            <div class="text">
                                <h2>
