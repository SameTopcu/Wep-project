        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="review">
                    <div class="set">
                    @php
                        $total_rating = $package->total_rating;
                        $total_score = $package->total_score;
                        $average_rating = $total_rating > 0 ? round($total_score / $total_rating, 1) : 0;
                    @endphp
                    @for($i = 1; $i <= 5; $i++)
                        @if($i <= floor($average_rating))
                        <i class="fas fa-star"></i>
                        @elseif($i == ceil($average_rating) && $average_rating - floor($average_rating) >= 0.3)
                            ...
                            <div class="review-package">
                                ...
                                <div class="review-package-section">
                                    <div class="review-package-box d-flex justify-content-start">
                                        ...
                                        <div class="right">
                                            ...
                                            <div class="date">{{ $review->created_at->format('d F Y') }}</div>
                                ...
                                @if(Auth::guard('web')->check())
                                    ...
                                    @if($review_possible > 0)
                                        @php
                                            $reviewed = App\Models\Review::where('package_id', $package->id)
                                                ->where('user_id', Auth::guard('web')->user()->id)
                                                ->count() > 0;
                                        @endphp
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        @foreach($tours as $tour)
                                            ...
                                            @php
                                                $i++;
                                                $total_booked_seats = App\Models\Booking::where('tour_id', $tour->id)
                                            ...
                                            <div class="summary">
                                                <div class="table-responsive">
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tr>
                                                            <td><b>Tour Total Seat:</b></td>
                                                            @if($tour->tour_total_seat > 0)
                                                            <td>{{ $tour->tour_total_seat }}</td>
                                                            @else
                                                            <td><span class="text-danger">Unlimited</span></td>
                                                            @endif
                                                        </tr>
                                                        <tr>
                                                            <td><b>Total Booked Seats:</b></td>
